...
<div class="applicantEducations form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Add Applicant Education') ?></legend>
        <?php
            ...
            echo $this->Form->input('has_evidence', ['options' => ['0' => __('No'), '1' => __('yes')], 'label' => ['text' => __('Has_Education_Evidence')]]);
            echo $this->Form->input('language_id', ['options' => $languages]);
            echo $this->Form->input('it_skills_rating', ['options' => ['1' => __('Poor'), '2' => __('Fair'), '3' => __('Good'), '4' => __('Excellent')], 'label' => ['text' => __('IT_Skills_Rating')]]);
