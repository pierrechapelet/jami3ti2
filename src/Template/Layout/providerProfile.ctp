...
<body>
    ...
    <section class="container clearfix mainstage">
        ...
        <div class="container main">
            <h1><i class="fa fa-bullseye" aria-hidden="true"></i> <?= $title ?></h1>
            
            <div class='row'><?php echo $this->element('menu_tabs_builder');  ?></div>

            <div class='row'><?php echo $this->Flash->render(); ?></div>
