...
<div class="applicantGenerals form large-9 medium-8 columns content">
    ...
    <fieldset>
        <?php
            ...
            echo $this->Form->input('marital_status', ['options' => ['1' => __('Single'), '2' => __('Married'), '3' => __('Divorced')], 'label' => ['text' => __('Marital Status')]]);
        ...
        <?php
            ...
            echo $this->Form->input('has_valid_passport', ['options' => ['0' => __('No'), '1' => __('yes')], 'label' => ['text' => __('Has Valid National Identity Card')]]);
            echo $this->Form->input('has_valid_idcard', ['options' => ['0' => __('No'), '1' => __('Yes')], 'label' => ['text' => __('Has Valid National Identity Card')]]);
        ?>
    </fieldset>
