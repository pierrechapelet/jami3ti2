    ...
    <div class="applicantGenerals view large-9 medium-8 columns content">
        <div class ='col-md-6'>
            ...
            <?php echo $this->Html->link(
                ...
                ['controller' => 'Opportunities', 'action' => 'edit',$opportunity->id ],
            ...
            <div class="applicantGenerals view large-9 medium-8 columns content">
                <div class ='col-md-4'>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?php echo 
                                        $_language == 'en_US' ? h($educationSub->education_field_of_study_sub->name_en) : h($educationSub->education_field_of_study_sub->name_ara) ?></td>
                                <td class="actions">
                    ...
                    <?php echo $this->Html->link(
                        ...
                        ['controller' => 'OpportunityEducations', 'action' => 'add',$opportunity->id ],
                        ['class' => 'btn btn-info', 'role' => 'button' , 'escape' => false]
                        );
                    ?>
                    </p> 
                ...
                <div class ='col-md-4'>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?php echo 
                                        $_language == 'en_US' ? h($educationTypes->education_desired_type->name_en) : h($educationTypes->education_desired_type->name_ara) ?></td>
                                <td class="actions">
                    ...
                    <?php echo $this->Html->link(
                        $this->Html->tag('span','',['class' => 'glyphicon glyphicon-plus']).' ' . __('Add'),
                        ['controller' => 'OpportunityEducationTypes', 'action' => 'add', $opportunity->id],
                        ['class' => 'btn btn-info', 'role' => 'button' , 'escape' => false]
                        );
                    ?>
                    </p>            
                ...
                <div class ='col-md-4'>
                    <h4>Target Countries</h3>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo $this->Html->link(
                                            $_language == 'en_US' ? h($opportunityCountry->country->name_en) : h($opportunityCountry->country->name_ara),
                                            ['controller' => 'Countries', 'action' => 'view', $opportunityCountry->country->code], 
                                            ['escape' => false])?></td>
                                    <td class="actions">
                        ...
                        <?php echo $this->Html->link(
                            $this->Html->tag('span','',['class' => 'glyphicon glyphicon-plus']).' ' . __('Add'),
                            ['controller' => 'OpportunityCountries', 'action' => 'add', $opportunity->id],
                            ['class' => 'btn btn-info', 'role' => 'button' , 'escape' => false]
                            );
                        ?>
                        </p>
            ...
            <div class="applicantGenerals view large-9 medium-8 columns content">
                    <div class ='col-md-12'>
                        <h4>Target Institutions</h3>
                            ...
                            <?php echo $this->Html->link(
                                $this->Html->tag('span','',['class' => 'glyphicon glyphicon-plus']).' ' . __('Add'),
                                ['controller' => 'OpportunityInstitutions', 'action' => 'add', $opportunity->id],
                                ['class' => 'btn btn-info', 'role' => 'button' , 'escape' => false]
                                );
