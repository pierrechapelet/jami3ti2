...
<div class="opportunityEducationTypes form large-9 medium-8 columns content">
    <?= $this->Form->create($opportunityEducationType) ?>
    <fieldset>
        <legend><?= __('Add Opportunity Education Type')
                     . ' ' . __('to') . ' ' .
