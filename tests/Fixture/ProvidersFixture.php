...
class ProvidersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'hq_addr_line1' => ['type' => 'string', 'length' => 200, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'hq_addr_line2' => ['type' => 'string', 'length' => 200, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'hq_addr_line3' => ['type' => 'string', 'length' => 200, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'country_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'hq_phone' => ['type' => 'string', 'length' => 15, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'hq_fax' => ['type' => 'string', 'length' => 15, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'hq_addr_line1' => 'Lorem ipsum dolor sit amet',
            'hq_addr_line2' => 'Lorem ipsum dolor sit amet',
            'hq_addr_line3' => 'Lorem ipsum dolor sit amet',
            'country_id' => 1,
            'hq_phone' => 'Lorem ipsum d',
            'hq_fax' => 'Lorem ipsum d',
            'city' => 'Lorem ipsum dolor sit amet',
            'postcode' => 1,
            'is_active' => 1,
            'created' => '2016-07-15 12:03:45',
            'modified' => '2016-07-15 12:03:45'
        ],
    ];
}
