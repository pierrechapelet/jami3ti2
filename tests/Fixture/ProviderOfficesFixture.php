...
/**
 * ProviderOfficesFixture
 *
 */
class ProviderOfficesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'postcode' => ['type' => 'string', 'length' => 200, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'is_active' => 1,
            'created' => '2016-07-15 12:04:16',
            'modified' => '2016-07-15 12:04:16'
        ],
    ];
}
