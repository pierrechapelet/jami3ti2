...
use App\Model\Table\OpportunityCountriesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\OpportunityCountriesTable Test Case
 */
class OpportunityCountriesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\OpportunityCountriesTable
     */
    public $OpportunityCountries;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('OpportunityCountries') ? [] : ['className' => 'App\Model\Table\OpportunityCountriesTable'];
        $this->OpportunityCountries = TableRegistry::get('OpportunityCountries', $config);
    }
    ...
    {
        unset($this->OpportunityCountries);
