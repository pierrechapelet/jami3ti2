...
use App\Model\Table\DonationCampaignProvidersTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\DonationCampaignProvidersTable Test Case
 */
class DonationCampaignProvidersTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\DonationCampaignProvidersTable
     */
    public $DonationCampaignProviders;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('DonationCampaignProviders') ? [] : ['className' => 'App\Model\Table\DonationCampaignProvidersTable'];
        $this->DonationCampaignProviders = TableRegistry::get('DonationCampaignProviders', $config);
    }
    ...
    {
        unset($this->DonationCampaignProviders);
