...
use App\Model\Table\OpportunityInstitutionsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\OpportunityInstitutionsTable Test Case
 */
class OpportunityInstitutionsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\OpportunityInstitutionsTable
     */
    public $OpportunityInstitutions;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('OpportunityInstitutions') ? [] : ['className' => 'App\Model\Table\OpportunityInstitutionsTable'];
        $this->OpportunityInstitutions = TableRegistry::get('OpportunityInstitutions', $config);
    }
    ...
    {
        unset($this->OpportunityInstitutions);
