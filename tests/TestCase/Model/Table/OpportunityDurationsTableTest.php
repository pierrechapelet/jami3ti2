...
use App\Model\Table\OpportunityDurationsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\OpportunityDurationsTable Test Case
 */
class OpportunityDurationsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\OpportunityDurationsTable
     */
    public $OpportunityDurations;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('OpportunityDurations') ? [] : ['className' => 'App\Model\Table\OpportunityDurationsTable'];
        $this->OpportunityDurations = TableRegistry::get('OpportunityDurations', $config);
    }
    ...
    {
        unset($this->OpportunityDurations);
