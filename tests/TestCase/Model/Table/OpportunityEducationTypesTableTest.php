...
use App\Model\Table\OpportunityEducationTypesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\OpportunityEducationTypesTable Test Case
 */
class OpportunityEducationTypesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\OpportunityEducationTypesTable
     */
    public $OpportunityEducationTypes;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('OpportunityEducationTypes') ? [] : ['className' => 'App\Model\Table\OpportunityEducationTypesTable'];
        $this->OpportunityEducationTypes = TableRegistry::get('OpportunityEducationTypes', $config);
    }
    ...
    {
        unset($this->OpportunityEducationTypes);
