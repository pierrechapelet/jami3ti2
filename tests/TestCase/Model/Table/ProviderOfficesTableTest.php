...
use App\Model\Table\ProviderOfficesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\ProviderOfficesTable Test Case
 */
class ProviderOfficesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\ProviderOfficesTable
     */
    public $ProviderOffices;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('ProviderOffices') ? [] : ['className' => 'App\Model\Table\ProviderOfficesTable'];
        $this->ProviderOffices = TableRegistry::get('ProviderOffices', $config);
    }
